...
int main(int argc, char* argv[]) {
    ...
    // Optimal vs Sequential test
    std::vector<int> optimal_threads = {4};
    std::vector<std::string> optimal_scales = {"scale_1.0x","scale_2.0x", "scale_4.0x"};
    std::vector<int> optimal_kernel = {3, 7, 15};
    //run_optimal_vs_sequential_test(optimal_scales, optimal_threads, optimal_kernel);
